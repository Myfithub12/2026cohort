...
function populateLineup() {
    const tbody = document.getElementById('lineup-body-ht');
...
function exportToExcel() {
    ...
    document.querySelectorAll('#lineup-body-ht tr').forEach(row => {
...
function populateLineup() {
    const tbody = document.getElementById('lineup-body-at');
    tbody.innerHTML = ""; // Cleared and fixed typo
...
function exportToExcel() {
    ...
    document.querySelectorAll('#lineup-body-at tr').forEach(row => {
        const cells = row.querySelectorAll('td');
        const rowData = Array.from(cells).map(cell => {
            const input = cell.querySelector('input');
